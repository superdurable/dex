...
5. When a bug leaves Flows stuck, **fix forward** then **time travel** from a safe point
...
## Continues and time travel

Very long Flows may continue-as-new. Time travel resumes execution from an earlier Step after a code fix. Combine with monitoring from [Application operations](/production/application-operations).
