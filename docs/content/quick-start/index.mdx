...
Build the same order-processing Flow as [Why Dex?](/intro/what-is-dex): install Dex, register a Worker and Client, start the Flow from an HTTP controller, approve shipment, and inspect the Execution graph in Dex Web.
...
![Dex Web Execution graph after approve](/img/quick-start/step-graph.png)
