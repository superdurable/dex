...
Full runnable samples live under `examples/{go,java,python,typescript,rust}` (HTTP prefix `/patterns/<name>/...` where applicable). Try them from the examples playground (`examples/playground`); see `examples/README.md`.
