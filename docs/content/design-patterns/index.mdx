...
- [Draining Channel for External Publishing](/design-patterns/draining-channel-for-external-publishing) — Process externally published messages, then complete when the Channel is empty.
