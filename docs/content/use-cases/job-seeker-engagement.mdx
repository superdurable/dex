...
- [**Attribute match**](/design-patterns/responsive-update/attribute-match) lets callers wait until durable state is visible.
...
<a href="/img/use-cases/job-seeker-engagement-step-execution-graph.jpg" target="_blank" rel="noreferrer">
  <img src="/img/use-cases/job-seeker-engagement-step-execution-graph.jpg" alt="Completed Job seeker engagement Step execution graph" />
</a>
...
- [Attribute match](/design-patterns/responsive-update/attribute-match)
