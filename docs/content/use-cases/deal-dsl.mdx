...
The Go product maps its six Keyword Attributes to **CustomKeyword** through **CustomKeyword6** in declaration order. Its raw searches always constrain **FlowType** before filtering one of those namespace-level slots.
