...
Use it when you want to drain Channels and complete the Flow, so the Flow can stay short. See [Draining External Channel Publishing](/design-patterns/draining-channel-for-external-publishing) for the full example.
