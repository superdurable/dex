...
<SdkTabs examples={{
python: 'examples/python/dex_examples/primitives/stream/controller.py',
go: 'examples/go/primitives/stream/controller.go',
java: 'examples/java/src/main/java/io/superdurable/dex/primitives/stream/StreamController.java',
typescript: 'examples/typescript/src/primitives/stream/controller.ts',
rust: 'examples/rust/src/primitives/stream/controller.rs',
}}>
<SdkSnippet lang="python">
