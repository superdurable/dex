...
**Flow** is a context-dependent umbrella term. Depending on the API, it usually means a registered Flow definition identified by its **FlowType**, or one logical Flow identified by its **Flow ID**.
