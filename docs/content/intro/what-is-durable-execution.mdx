...
More experienced backend engineers usually adopt two message queues: "charge-request" and "ship-requests" queue.
...
See [What is Dex?](/intro/what-is-dex) for how Dex implements this flow and how to run the example.
