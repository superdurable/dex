...
关闭决策、取消、Flow 输出与 forceCompleteIfChannelsEmpty 见 [高级 Step decision](/primitives/step/step-decision)。超时、retry 及相关策略的自定义见 [高级 Step options](/primitives/step/step-options)。
