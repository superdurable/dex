...
return StepDecision.goToMany(
        StepMovement.of(CarrierA.class, quoteA),
        StepMovement.of(CarrierB.class, quoteB),
        StepMovement.of(Winner.class, winnerQuote));
```
...
Ok(StepDecision::go_to_many([
    StepMovement::to(&CarrierA, quote_a),
    StepMovement::to(&CarrierB, quote_b),
    StepMovement::to(&Winner, winner_quote),
]))
```
