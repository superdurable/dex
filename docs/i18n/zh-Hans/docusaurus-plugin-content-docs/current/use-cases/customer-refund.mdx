...
Go customer-refund 产品包含两个自包含的 Flow。两者都会发布 Flow Definition Graph 2.0 元数据，供 Process Canvas 与 Dex Web Supervision 使用。
...
协议与操作流程见 [Supervision](/production/supervision)。
