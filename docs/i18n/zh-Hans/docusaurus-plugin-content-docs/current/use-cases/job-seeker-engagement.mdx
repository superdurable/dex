...
- [**Attribute 匹配**](/design-patterns/responsive-update/attribute-match)让调用方等待 durable 状态可见。
...
<a href="/img/use-cases/job-seeker-engagement-step-execution-graph.jpg" target="_blank" rel="noreferrer">
  <img src="/img/use-cases/job-seeker-engagement-step-execution-graph.jpg" alt="已完成的求职者沟通 Step execution graph" />
</a>
