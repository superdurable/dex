...
* Start a Dex server following the [instructions](https://github.com/superdurable/dex#how-to-use)
  * The easiest way is to run `docker run -p 8801:8801 -p 7233:7233 -p 8233:8233 -e AUTO_FIX_WORKER_URL=host.docker.internal --add-host host.docker.internal:host-gateway -it superdurable/dex-server-lite:latest`
...
<img width="773" alt="Screenshot 2024-01-01 at 10 06 11 PM" src="https://github.com/superdurable/dex-golang-samples/assets/4523955/bca7e02c-f24c-4288-9fc6-1cca74a7c1d3">
* You can use query handler to look at the current data like this
<img width="618" alt="Screenshot 2024-01-01 at 10 08 41 PM" src="https://github.com/superdurable/dex-golang-samples/assets/4523955/2909b494-5b05-404a-a047-31394eb4b43c">
