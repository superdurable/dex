...
This [Subscription workflow](https://github.com/superdurable/iwf/tree/main/examples/go/workflows/subscription) (with unit tests) is to match the use case described in
