...
```text
http://localhost:8080/products/polling/start?workflowId=polling-1&pollingCompletionThreshold=2
http://localhost:8080/products/polling/complete?workflowId=polling-1&channel=task-a-completed
http://localhost:8080/products/polling/complete?workflowId=polling-1&channel=task-b-completed
```
