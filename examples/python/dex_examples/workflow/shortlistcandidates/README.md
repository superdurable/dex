...
```text
http://localhost:8080/shortlistcandidates/opt_in?employerId=e1
http://localhost:8080/shortlistcandidates/shortlist?employerId=e1&candidateId=c1
http://localhost:8080/shortlistcandidates/revoke_shortlist?employerId=e1&candidateId=c1
http://localhost:8080/shortlistcandidates/opt_out?employerId=e1
```
