...
@RestController
@RequestMapping("/primitives/subflow")
public final class SubFlowController {
    private final Client client;
    private final SubFlowParentFlow flow;

    public SubFlowController(final Client client, final SubFlowParentFlow flow) {
        this.client = client;
        this.flow = flow;
    }
