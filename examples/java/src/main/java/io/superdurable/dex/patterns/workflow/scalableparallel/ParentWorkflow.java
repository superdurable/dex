...
import io.superdurable.dex.core.communication.*;
...
import static io.superdurable.dex.patterns.workflow.scalableparallel.ChildWorkflow.PARENT_WORKFLOW_ID;
import static io.superdurable.dex.patterns.workflow.scalableparallel.ParentWorkflow.*;
import static io.superdurable.dex.patterns.workflow.scalableparallel.ParentWorkflow.*;
...
public class ParentWorkflow implements ObjectWorkflow {
    ...
    public ParentWorkflow(final Client dexClient) {
        this.stateDefs = Arrays.asList(
                StateDef.startingState(new InitState()),
                StateDef.nonStartingState(new LoopForNextMessageState(dexClient))
        );
    }
...
class LoopForNextMessageState implements WorkflowState<Void> {
    ...
    public LoopForNextMessageState(final Client dexClient) {
