...
@RestController
@RequestMapping("/primitives/step/step-decision")
public final class StepDecisionController {
    private final Client client;
    private final StepDecisionFlow flow;

    public StepDecisionController(final Client client, final StepDecisionFlow flow) {
        this.client = client;
        this.flow = flow;
    }
