...
import io.superdurable.dex.core.WorkerService;
...
import static io.superdurable.dex.core.WorkerService.WORKFLOW_STATE_EXECUTE_API_PATH;
import static io.superdurable.dex.core.WorkerService.WORKFLOW_STATE_WAIT_UNTIL_API_PATH;
import static io.superdurable.dex.core.WorkerService.WORKFLOW_WORKER_RPC_API_PATH;

@Controller
@RequestMapping("/worker")
public class DexWorkerApiController {

    private final WorkerService workerService;

    public DexWorkerApiController(final WorkerService workerService) {
    ...
    /**
     * This exception handler will return error response to Dex server so that you can debug using Cadence/Temporal history(WebUI)
     *
     * @param req
     * @param ex
     * @return
