...
@RestController
@RequestMapping("/primitives/step/custom-retry")
public final class CustomRetryController {
    private final Client client;
    private final CustomRetryFlow flow;

    public CustomRetryController(final Client client, final CustomRetryFlow flow) {
        this.client = client;
        this.flow = flow;
    }
    ...
    public ResponseEntity<Map<String, String>> start(
            ...
            @RequestParam final int readyAfterAttempt) {
