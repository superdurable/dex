...
@RestController
@RequestMapping("/primitives/rpc")
public final class RpcController {
    private final Client client;
    private final RpcFlow flow;

    public RpcController(final Client client, final RpcFlow flow) {
        this.client = client;
        this.flow = flow;
    }
    ...
    public ResponseEntity<Map<String, String>> start(
        ...
        final String runId =
                client.startFlow(flow, workflowId, 0, ExampleFlows.startOptions());
