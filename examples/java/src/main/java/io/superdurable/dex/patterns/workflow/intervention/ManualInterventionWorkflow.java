...
package io.superdurable.dex.patterns.workflow.intervention;
...
import static io.superdurable.dex.patterns.workflow.intervention.ManualInterventionWorkflow.INTERNAL_CHANNEL_COMMAND;
import static io.superdurable.dex.patterns.workflow.intervention.ManualInterventionWorkflow.NUMBER_OF_RETRIES;
import static io.superdurable.dex.patterns.workflow.intervention.ManualInterventionWorkflow.SIGNAL_CHANNEL_COMMAND_RETRY;
 ...
 * <pre>
 * Signal name: __DexSystem_ExecuteRpc
 * Data:
 * {
 ...
 * is another, programmatic way to add a manual intervention or you can also use dex's built-in endpoint.
