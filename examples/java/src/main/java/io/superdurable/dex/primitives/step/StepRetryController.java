...
@RestController
@RequestMapping("/primitives/step/retry")
public final class StepRetryController {
    private final Client client;
    private final RetryingFailureFlow flow;

    public StepRetryController(final Client client, final RetryingFailureFlow flow) {
        this.client = client;
        this.flow = flow;
    }
