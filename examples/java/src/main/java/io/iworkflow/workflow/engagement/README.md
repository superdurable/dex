...
## Controller
And controller is a very thin layer of calling iWF client APIs and workflow RPC stub APIs. See [EngagementController](https://github.com/superdurable/iwf/blob/main/examples/java/src/main/java/io/iworkflow/controller/EngagementWorkflowController.java).
