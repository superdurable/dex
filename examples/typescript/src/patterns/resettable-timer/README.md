...
Here we demonstrate a basic and common design pattern for building workflows with Dex:
...
![Resettable Timer Workflow](./assets/Dex-Design-Patterns_ResettableTimer.drawio.png)
