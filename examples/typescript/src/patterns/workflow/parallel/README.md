...
Here we demonstrate how to take advantage of the parallel running states feature in Dex.
...
![Simple Parallel State Workflow](./assets/Dex-Design-Patterns_SimpleParallel.png)
...
![Await All Parallel States Workflow](./assets/Dex-Design-Patterns_AwaitParallel.png)
