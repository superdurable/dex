...
Here we demonstrate two basic and common design patterns for building workflows with Dex:
...
![Basic Polling](./assets/Dex-Design-Patterns_BasicPolling.png)
...
![Backoff Polling](./assets/Dex-Design-Patterns_BackoffPolling.png)
