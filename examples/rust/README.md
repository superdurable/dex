...
| Draining Channel for external publishing | [`DrainingChannelFlow`](src/patterns/drain_channels/flow.rs) | RPC publication, one-at-a-time drain, conditional completion |
