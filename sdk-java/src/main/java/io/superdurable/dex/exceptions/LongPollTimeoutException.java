 ...
 *
 * <p>This exception can be thrown by {@link Client#waitForFlow(String, java.time.Duration)}.
 * Durable Step and Attribute waits reattach long polls internally. The timeout does not itself
 * indicate a Flow failure. Callers may catch it and repeat the same exposed long-poll operation.
 */
