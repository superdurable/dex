...
The goal of Dex is to write **MINIMUM** code to support any database. Dex creates a minimum interface to implement an extension.
...
Dex will support any database as long as it can:
