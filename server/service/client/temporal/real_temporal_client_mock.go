...
// Source: go.temporal.io/sdk/client (interfaces: Client,NamespaceClient)
...
func (mr *MockClientMockRecorder) CompleteActivityByActivityID(ctx, namespace, activityID, activityRunID, result, err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CompleteActivityByActivityIDWithOptions(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CompleteActivityByIDWithOptions(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CompleteActivityWithOptions(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CountActivities(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) CountNexusOperations(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockClient) ExecuteActivity(ctx context.Context, options client.StartActivityOptions, activity any, args ...any) (client.ActivityHandle, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, options, activity}
	for _, a := range args {
...
func (mr *MockClientMockRecorder) ExecuteActivity(ctx, options, activity interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, options, activity}, args...)
...
func (mr *MockClientMockRecorder) GetActivityHandle(options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetNexusOperationHandle(options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) ListActivities(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) ListNexusOperations(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) NewNexusClient(options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) RecordActivityHeartbeatByIDWithOptions(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) RecordActivityHeartbeatWithOptions(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
