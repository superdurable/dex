...
func (p sqlProcessStoreImpl) doRecoverFromStateExecutionFailureTx(
	...
	currStateRow := extensions2.AsyncStateExecutionRowForUpdateWithoutCommands{
		...
		Status:             data_models2.StateExecutionStatusFailed,
	...
	stateInfoBytes, err := data_models2.FromAsyncStateExecutionInfoToBytesForStateRecovery(
	...
	stateInputBytes, err := data_models2.FromEncodedObjectIntoBytes(&stateInput)
	if err != nil {
		return err
	}
