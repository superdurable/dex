...
indefinitely. `internalHandlerTimeoutMs` is an advanced Temporal Update
generation lifetime; zero disables timed rollover. Request expiry throws
`RequestTimeoutError`. Handler rollover stays internal.
