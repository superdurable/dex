...
export const ErrorSubStatus = Object.freeze({
  ...
  /** A caller-defined wait budget expired while the accepted handler may remain pending. */
...
/** Indicates that a caller-defined wait budget expired while the accepted handler may remain pending. */
