...
//
//	mockgen -source=./workflow_context.go -package=dextest -destination=../dextest/workflow_context.go
//
...
func (mr *MockWorkflowContextMockRecorder) Value(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
