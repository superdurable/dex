...
//
//	mockgen -source=./persistence.go -package=dextest -destination=../dextest/persistence.go
//
...
func (m *MockPersistence) GetToReturn() ([]dexpb.KeyValue, []dexpb.KeyValue, []dexpb.KeyValue, []dexpb.SearchAttribute) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetToReturn")
	ret0, _ := ret[0].([]dexpb.KeyValue)
	ret1, _ := ret[1].([]dexpb.KeyValue)
	ret2, _ := ret[2].([]dexpb.KeyValue)
	ret3, _ := ret[3].([]dexpb.SearchAttribute)
...
// GetToReturn mocks base method.
func (m *MockpersistenceInternal) GetToReturn() ([]dexpb.KeyValue, []dexpb.KeyValue, []dexpb.KeyValue, []dexpb.SearchAttribute) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetToReturn")
	ret0, _ := ret[0].([]dexpb.KeyValue)
	ret1, _ := ret[1].([]dexpb.KeyValue)
