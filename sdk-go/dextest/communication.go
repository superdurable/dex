...
//
//	mockgen -source=./communication.go -package=dextest -destination=../dextest/communication.go
//
...
func (m *MockCommunication) GetToPublishInternalChannel() map[string][]dexpb.EncodedObject {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetToPublishInternalChannel")
	ret0, _ := ret[0].(map[string][]dexpb.EncodedObject)
	return ret0
}
...
func (m *MockCommunication) GetToTriggerStateMovements() []dex.StateMovement {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetToTriggerStateMovements")
	ret0, _ := ret[0].([]dex.StateMovement)
	return ret0
}
...
func (m *MockCommunication) TriggerStateMovements(movements ...dex.StateMovement) {
	m.ctrl.T.Helper()
	varargs := []any{}
...
// GetToPublishInternalChannel mocks base method.
func (m *MockcommunicationInternal) GetToPublishInternalChannel() map[string][]dexpb.EncodedObject {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetToPublishInternalChannel")
	ret0, _ := ret[0].(map[string][]dexpb.EncodedObject)
	return ret0
...
// GetToTriggerStateMovements mocks base method.
func (m *MockcommunicationInternal) GetToTriggerStateMovements() []dex.StateMovement {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetToTriggerStateMovements")
	ret0, _ := ret[0].([]dex.StateMovement)
	return ret0
