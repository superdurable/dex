...
Successful Temporal RPC Updates appear as the same RPC events as Cadence result
signals. Blob-backed RPC input and output hydrate through the existing selected-event loader.
